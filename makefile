...
.PHONY: install_debug
install_debug:
	sudo cp -R ./Build/Products/Debug/AppleSmartBatteryManager.kext /System/Library/Extensions
	make update_kernelcache

.PHONY: install
install:
	sudo cp -R ./Build/Products/Release/AppleSmartBatteryManager.kext /System/Library/Extensions
	make update_kernelcache
